...
export const enableLog = createRule<MyRuleOptions,MessageIds>({
    ...
    meta: {
        ...
        messages: {
            [MessageIds.LOG_FOUND]: 'logs should not be declared to false in GCP backend services',
            [MessageIds.LOG_FIX]: "Change boolean value {{ left }} of {{ right }} to true",
            [MessageIds.NO_LOG_FOUND]: "Logs should be declared and enabled in GCP backend severices",
